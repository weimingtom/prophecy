 ...
 */
public class Player {
    public static final int RATE_FACT = TestClientMT.RATE_FACT; // 速度因子
	...
	double distance = Math.hypot((targetPoint.x - point.x),
	...
	if (isMoveEnd) {
	    setTargetPoint(new Point((int) (TestClientMT.WINDOW_WIDTH * Math
		    .random()), (int) (TestClientMT.WINDOW_HEIGHT * Math
		    .random())));
	    isMoveEnd = false;
	    return true;
	}
